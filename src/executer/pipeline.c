...
/*   Updated: 2025/10/15 20:54:14 by dvavryn          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static void	child_builtin(t_data *data, t_cmd *cmd)
{
	int	ret;
...
static int	child(t_data *data, t_cmd *cmd)
{
...
static int	pipeline_child(t_data *data, t_cmd *cmd, t_exec *exec)
{
	char	*buf;
